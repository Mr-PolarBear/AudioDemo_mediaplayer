package com.jack.ma.audiodemo.view;
...
//        Log.d(TAG, "震动频率-->" + log);
    ...
    private void init() {
        ...
        mPaint.setStrokeWidth(dp2px(3f)); // 画笔的粗细

        mLintToLineW = dp2px(5);
        mFrameNum = dp2px(4);
        mShortLineHgt = dp2px(15);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mLines.size(); i++) {
            ...
            float endY = line.stopY - mLintToLineW * 2;
            float startY = line.startYs[mLeveNum] > endY ? endY : line.startYs[mLeveNum];
            canvas.drawLine(line.x, startY, line.x, endY, mPaint);
            logT("开始的y" + line.startYs[mLeveNum] + "结束的y" + line.stopY);
        }
    }
